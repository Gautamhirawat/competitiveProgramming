...
def update_bars(low, high, mid, found):
    ...
    if found:
        ...
        title.set_text(f"Interpolation Search - Low: {low}, High: {high}, Mid: {mid}")
...
search_gen = interpolation_search(sorted_array, value_to_search)
...
while True:
    try:
        ...
        if sorted_array[mid] == value_to_search:
            ...
            print("Time Complexity: O(log log n)")
